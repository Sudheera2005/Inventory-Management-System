...
namespace inventory
{
    public partial class EditForm : Form
    {
        ...
        // Add a constructor parameter to pass the product data  
        public EditForm(Dictionary<string, object> product)
        {
            InitializeComponent();
        ...
        private void buttoned1_Click(object sender, EventArgs e)
        {
            this.Close(); // Close the form without saving changes
        }

        private void buttoned2_Click(object sender, EventArgs e)
        {
